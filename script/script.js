        ...
        // GSAP Animations - Commented temporarily for debugging
        /*
        ...
        */
        ...
        function debugProjects() {
            ...
            projectCards.forEach((card, index) => {
                console.log(`Project ${index + 1}:`, card.querySelector('h3')?.textContent);
        ...
        window.addEventListener('load', () => {
            initThreeJS();
            updateActiveNav();
            debugProjects(); // Added debug function
        });
        ...
        // Console easter egg
        console.log(`
        🚀 Oumayma Bramid's Portfolio
        ================================
        
        Passionate Full-Stack Developer
        
        Live projects:
        • Interactive Microservices Architecture: https://oumaymabrd.github.io/Architecture-Microservices-Interactive/
        • Futuristic Animated Mockup: https://oumaymabrd.github.io/makete_anime/
        • WhatsApp-Style Real-Time Chat: https://github.com/OumaymaBrd/Chat_temps_reel
        ...
        Contact me: oumaymabramid@gmail.com
